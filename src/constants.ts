...
export const BENTO_TARGET_ASPECT_RATIO = 0.9;
export const BENTO_TARGET_CELL_AREA_PER_CARD = 1.72;
export const BENTO_MIN_CELL_AREA_PER_CARD = 1.45;
export const BENTO_MAX_CELL_AREA_PER_CARD = 2;
